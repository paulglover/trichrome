"""
trichrome — merge red/green/blue-light RAW triplets into linear DNGs.
...
from .bake import (Job, JobResult, Summary, collect_raw_files, plan_jobs,
                   run_jobs)
